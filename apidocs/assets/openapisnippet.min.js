...
const OpenAPISampler=require("openapi-sampler"),createHar=function(e,t,s,a){void 0===a&&(a={});const r=getBaseUrl(e,t,s),o={method:s.toUpperCase(),url:r+getFullPath(e,t,s),headers:getHeadersArray(e,t,s),queryString:getQueryStrings(e,t,s,a),httpVersion:"HTTP/1.1",cookies:[],headersSize:0,bodySize:0};let n=[];const i=getPayloads(e,t,s);if(i.length>0)for(let e in i){const t=i[e],s=JSON.parse(JSON.stringify(o));s.postData=t,s.comment=t.mimeType,s.headers.push({name:"content-type",value:t.mimeType}),n.push(s)}else n=[o];return n},getPayloads=function(e,t,s){if(void 0!==e.paths[t][s].parameters)for(let a in e.paths[t][s].parameters){const r=e.paths[t][s].parameters[a];if(void 0!==r.in&&"body"===r.in.toLowerCase()&&void 0!==r.schema)try{const t=OpenAPISampler.sample(r.schema,{skipReadOnly:!0},e);return[{mimeType:"application/json",text:JSON.stringify(t)}]}catch(e){return console.log(e),null}}e.paths[t][s].requestBody&&e.paths[t][s].requestBody.$ref&&(e.paths[t][s].requestBody=resolveRef(e,e.paths[t][s].requestBody.$ref));const a=[];return e.paths[t][s].requestBody&&e.paths[t][s].requestBody.content&&["application/json","application/x-www-form-urlencoded","multipart/form-data"].forEach(r=>{const o=e.paths[t][s].requestBody.content[r];if(o&&o.schema){const t=OpenAPISampler.sample(o.schema,{skipReadOnly:!0},e);if("application/json"===r)a.push({mimeType:r,text:JSON.stringify(t)});else if("multipart/form-data"===r){if(void 0!==t){const e=[];Object.keys(t).forEach(s=>{let a=t[s];"string"!=typeof t[s]&&(a=JSON.stringify(t[s])),e.push({name:s,value:a})}),a.push({mimeType:r,params:e})}}else if("application/x-www-form-urlencoded"==r){if(void 0===t)return null;const e=[];Object.keys(t).map(s=>e.push({name:encodeURIComponent(s).replace(/\%20/g,"+"),value:encodeURIComponent(t[s]).replace(/\%20/g,"+")})),a.push({mimeType:"application/x-www-form-urlencoded",params:e,text:Object.keys(e).map(e=>e+"="+t[e]).join("&")})}}}),a},getBaseUrl=function(e,t,s){if(e.paths[t][s].servers)return e.paths[t][s].servers[0].url;if(e.paths[t].servers)return e.paths[t].servers[0].url;if(e.servers)return e.servers[0].url;let a="";return void 0!==e.schemes?a+=e.schemes[0]:a+="http","/"===e.basePath?a+="://"+e.host:a+="://"+e.host+e.basePath,a},getParameterValues=function(e,t){let s="SOME_"+(e.type||e.schema.type).toUpperCase()+"_VALUE";return t&&void 0!==t[e.name]?s=t[e.name]+"":void 0!==e.default?s=e.default+"":void 0!==e.schema&&void 0!==e.schema.example?s=e.schema.example+"":void 0!==e.example&&(s=e.example+""),{name:e.name,value:s}},parseParametersToQuery=function(e,t,s){const a={};for(let r in t){let o=t[r];"string"==typeof o.$ref&&/^#/.test(o.$ref)&&(o=resolveRef(e,o.$ref)),void 0!==o.schema&&"string"==typeof o.schema.$ref&&/^#/.test(o.schema.$ref)&&(o.schema=resolveRef(e,o.schema.$ref),void 0===o.schema.type&&(o.schema.type="object")),void 0!==o.in&&"query"===o.in.toLowerCase()&&(a[o.name]=getParameterValues(o,s))}return a},getQueryStrings=function(e,t,s,a){void 0===a&&(a={});let r={},o={};void 0!==e.paths[t].parameters&&(r=parseParametersToQuery(e,e.paths[t].parameters,a)),void 0!==e.paths[t][s].parameters&&(o=parseParametersToQuery(e,e.paths[t][s].parameters,a));const n=Object.assign(r,o);return Object.values(n)},getFullPath=function(e,t,s){let a=t;const r=e.paths[t].parameters||e.paths[t][s].parameters;if(void 0!==r)for(let t in r){let s=r[t];"string"==typeof s.$ref&&/^#/.test(s.$ref)&&(s=resolveRef(e,s.$ref)),void 0!==s.in&&"path"===s.in.toLowerCase()&&void 0!==s.example&&(a=a.replace("{"+s.name+"}",s.example))}return a},getHeadersArray=function(e,t,s){const a=[],r=e.paths[t][s];if(void 0!==r.consumes)for(let e in r.consumes){const t=r.consumes[e];a.push({name:"accept",value:t})}if(void 0!==r.parameters)for(let e in r.parameters){const t=r.parameters[e];void 0!==t.in&&"header"===t.in.toLowerCase()&&a.push(getParameterValues(t))}let o,n,i;if(void 0!==r.security)for(var p in r.security){const t=Object.keys(r.security[p])[0],s=e.securityDefinitions?e.securityDefinitions[t]:e.components.securitySchemes[t],a=s.type.toLowerCase();let c=null;switch("apikey"!==a&&null!=s.scheme&&(c=s.scheme.toLowerCase()),a){case"basic":o=t;break;case"apikey":"header"===s.in&&(n=s);break;case"oauth2":i=t;break;case"http":switch(c){case"bearer":i=t;break;case"basic":o=t}}}else if(void 0!==e.security)for(let t in e.security){const s=Object.keys(e.security[t])[0],a=e.components.securitySchemes[s],r=a.type.toLowerCase();let p=null;switch("apikey"!==r&&"oauth2"!==r&&(p=a.scheme.toLowerCase()),r){case"http":switch(p){case"bearer":i=s;break;case"basic":o=s}break;case"basic":o=s;break;case"apikey":"header"===a.in&&(n=a);break;case"oauth2":i=s}}return o?a.push({name:"Authorization",value:"Basic REPLACE_BASIC_AUTH"}):n?a.push({name:n.name,value:"REPLACE_KEY_VALUE"}):i&&a.push({name:"Authorization",value:"Bearer REPLACE_BEARER_TOKEN"}),a},openApiToHarList=function(e){try{const t=[];for(let s in e.paths)for(let a in e.paths[s]){const r=getBaseUrl(e,s,a)+s,o=createHar(e,s,a);t.push({method:a.toUpperCase(),url:r,description:e.paths[s][a].description||"No description available",hars:o})}return t}catch(e){console.log(e)}},resolveRef=function(e,t){const s=t.split("/");if(s.length<=1)return{};const a=function(e,t){if(t+1<s.length){let r=t+1;return a(e[s[t]],r)}return e[s[t]]};return a(e,1)};module.exports={getAll:openApiToHarList,getEndpoint:createHar};
